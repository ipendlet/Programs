...
//  inpfile << " PM7 NOSYM " << endl;
//  inpfile << " PM7 NOSYM GNORM=0.7 " << endl;
#if !UNRESTRICTED
#if !CATION
  inpfile << " PM6 NOSYM GNORM=1.5 " << endl;
#else
  inpfile << " PM6 NOSYM GNORM=1.5 CHARGE=1 " << endl;
#endif
#else
#if !CATION 
#if !TRIPLET
  inpfile << " PM6 NOSYM GNORM=1.5 UHF " << endl;
#else
  inpfile << " PM6 NOSYM GNORM=1.5 UHF TRIPLET" << endl;
#endif
#else
  inpfile << " PM6 NOSYM GNORM=1.5 UHF CHARGE=1 " << endl;
#endif
#endif
